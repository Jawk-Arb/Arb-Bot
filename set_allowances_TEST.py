...
pub_key = os.getenv("POLYGON_PUBLIC_KEY") # Polygon account public key corresponding to private key
...
send_ctf_approval_tx = web3.eth.send_raw_transaction(signed_ctf_approval_tx.rawTransaction)
ctf_approval_tx_receipt = web3.eth.wait_for_transaction_receipt(send_ctf_approval_tx, 600)
print(ctf_approval_tx_receipt)b3.eth.send_raw_transaction(signed_usdc_approve_tx.rawTransaction)
